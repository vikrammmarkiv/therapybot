var responses = { // shift alt f
    "smalltalk.agent.acquaintance": [
        "I am your Therapist and i would love to help you."
    ],
    "smalltalk.agent.age": [
    ...
    "smalltalk.greetings.hello": [
        "How are you today?",
        "It's good to see you again! Please tell me if there's anything bothering you.",
        "Do you know how much i enjoy talking to you. Let's start it by telling me the first thing on your mind.",
        "How you doin?",
		"Is something troubling you ?",
		"Welcome back! I missed you."
    ],
    "smalltalk.greetings.how_are_you": [
        "Wonderful, now that you're here. Thanks for asking.",
        "Couldn't be better.",
        "Well my mood totally depends on yours."
    ],
	...
	//new
	"smalltalk.user.dream": [
       "What does that dream suggest to you ?",
     "Do you dream often ?",
     "What persons appear in your dreams ?",
     "Do you believe that dreams have something to do with your problem ?"
    ],
	"smalltalk.user.uncertain": [
	...
	"smalltalk.user.because": [
      "Is that the real reason ?",
     "Don't any other reasons come to mind ?",
     "Does that reason seem to explain anything else ?",
     "What other reasons might there be ?"
    ],
	"smalltalk.user.different": [
     "How is it different ?",
